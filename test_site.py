...
def render_channel_growth_page(base_url: str = "") -> str:
    ...
    for idx, item in enumerate(growth_ranked[:50], start=1):
        ...
        row_videos = f'<span class="embedded-video-list">{embedded_videos}</span>' if idx <= 10 else ""
        growth_items.append(
