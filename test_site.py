...
<aside class="panel"><div class="side-block"><h3 class="side-info-head">現在のランキング情報</h3><div class="side-info"><div class="side-info-row"><span>更新日</span><strong>__UPDATED_DATE__</strong></div><div class="side-info-row"><span>24h総増加</span><strong>+__TOTAL_GROWTH__</strong></div><div class="side-info-row"><span>本日増えた動画数</span><strong>__NEW_24H__</strong></div><div class="side-info-row"><span>トラッキング数</span><strong>__TRACKING_VIDEOS__</strong></div><div class="side-info-row"><span>総ライク数</span><strong>__TOTAL_LIKES__</strong></div><div class="side-info-row"><span>総コメント数</span><strong>__TOTAL_COMMENTS__</strong></div></div></div><div class="panel" style="padding:12px;margin:0;border-radius:10px;"><h2 class="pickup-head">✨️新着ピックアップ</h2><div class="pickup-list">__PICKUP_HTML__</div></div></aside></section></main>
