...
<aside class="panel"><h2 style="margin:0 0 10px;color:#1f3344;font-size:1rem;font-weight:800;">ページ情報</h2><div class="info-list"><div class="info-row"><span>更新基準</span><strong>最新値 - 24時間前の値（動画単位）</strong></div><div class="info-row"><span>増加率の対象条件</span><strong>対象動画2本以上 / 24h前合計1万再生以上</strong></div><div class="info-row"><span>24h総増加</span><strong class="growth">▶ +__TOTAL_GROWTH__</strong></div><div class="info-row"><span>増加数ランキング</span><strong>__GROWTH_COUNT__ チャンネル</strong></div><div class="info-row"><span>増加率ランキング</span><strong>__RATE_COUNT__ チャンネル</strong></div></div></aside></section></main>
