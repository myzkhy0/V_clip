...
<aside class="panel"><div class="side-block"><h3 class="side-info-head">チャンネルランキング情報</h3><div class="side-info"><div class="side-info-row"><span>更新日</span><strong>__UPDATED_DATE__</strong></div><div class="side-info-row"><span>24h総増加</span><strong>+__TOTAL_GROWTH__</strong></div><div class="side-info-row"><span>本日増えた動画数</span><strong>__NEW_24H__</strong></div><div class="side-info-row"><span>トラッキング数</span><strong>__TRACKING_VIDEOS__</strong></div></div></div><h2 class="pickup-head">✨️新着ピックアップ</h2><div class="pickup-list">__PICKUP_HTML__</div></aside></section></main>
