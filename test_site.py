...
<aside class="panel"><h2 class="pickup-head">✨️新着ピックアップ</h2><div class="side-info"><div class="side-info-row"><span>最終更新（JST）</span><strong>__UPDATED__</strong></div><div class="side-info-row"><span>24h総増加</span><strong>+__TOTAL_GROWTH__</strong></div><div class="side-info-row"><span>表示件数</span><strong>5件</strong></div></div><div class="pickup-list">__PICKUP_HTML__</div></aside></section></main>
