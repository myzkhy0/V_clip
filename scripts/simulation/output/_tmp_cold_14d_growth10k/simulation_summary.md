...
- Generated at: `2026-03-17T04:15:21.134497+00:00`
- Output dir: `scripts\simulation\output\_tmp_cold_14d_growth10k`
...
- Simulated daily refresh jobs: **2280.33**
- Simulated weekly refresh jobs: **15962.33**
- Simulated daily API cost: **2280.33**
- Simulated weekly API cost: **15962.33**
- Current (fixed) daily API cost: **2286.00**
- Current (fixed) weekly API cost: **16002.00**
- Estimated savings ratio: **0.25%**

## Coverage / Risk Highlights

- Risk-flagged channels: **1**
- Examples:
